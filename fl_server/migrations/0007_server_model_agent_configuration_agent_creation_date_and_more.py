    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_training', models.CharField(choices=[('FS', 'On the Federated Server'), ('LA', 'On a Specific Local Agent'), ('AA', 'On all Local Participating Agents'), ('AX', 'On all Local Participating Agents excluding some of them'), ('FL', 'In Federated Learning')], default='LA', max_length=2)),
                ('model_origin', models.CharField(choices=[('AG', 'Local Agent'), ('AS', 'Aggregator Server')], default='AG', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('server_aggregator_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('server_aggregator_method', models.CharField(choices=[('FA', 'FedAvg')], default='FA', max_length=2)),
                ...
                ('server_aggregator_model_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='server_aggregator_model_id', to='fl_server.server_model')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('federated_autorisation_agent_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='federated_authorisation_agent_id', to='fl_server.agent_configuration')),
                ('federated_autorisation_model_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='federated_authorisation_model_id', to='fl_server.server_model')),
            ],
        ),
    ]
