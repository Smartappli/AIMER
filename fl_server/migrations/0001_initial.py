    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_provider', models.CharField(choices=[('HF', 'Hugging Face')], default='HF', max_length=2)),
                ...
                ('family_model_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='family_model_id', to='fl_server.nlp_model_family')),
            ],
        ),
        migrations.CreateModel(
            name='NLP_Model_File',
            fields=[
                ...
                ('NLP_model_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='NLP_model_id', to='fl_server.nlp_model')),
            ],
        ),
    ]
