...
class TestNodeLaunch(unittest.TestCase):
    ...
    def test_register_user(self, mock_login):
        ...
        node = MagicMock()
        client = register_user(node, "info@openmined.org", "changethis", "Jane Doe", "Caltech", "https://www.caltech.edu/")

        mock_login.assert_called_once_with(email="info@openmined.org", password="changethis")
