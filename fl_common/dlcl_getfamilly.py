...
def get_family_model_m(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "repghostnetv2_conv_medium": get_mobilenet_model,
        "repghostnetv2_conv_large": get_mobilenet_model,
        "repghostnetv2_conv_aa_medium": get_mobilenet_model,
        "repghostnetv2_conv_blur_medium": get_mobilenet_model,
