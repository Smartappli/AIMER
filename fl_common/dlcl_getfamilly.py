...
from fl_common.models.hieradnet_sam2 import get_hieradet_sam2_model
...
def get_family_model_c(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "test_convnext": get_convnext_model,
        "test_convnext2": get_convnext_model,
        "test_convnext3": get_convnext_model,
...
def get_family_model_e(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "mobilenetv1_100": get_efficientnet_model,
        "mobilenetv1_100h": get_efficientnet_model,
        "mobilenetv1_125": get_efficientnet_model,
        ...
        "mobilenet_edgetpu_100": get_efficientnet_model,
        "mobilenet_edgetpu_v2_xs": get_efficientnet_model,
        "mobilenet_edgetpu_v2_s": get_efficientnet_model,
        "mobilenet_edgetpu_v2_m": get_efficientnet_model,
        "mobilenet_edgetpu_v2_l": get_efficientnet_model,
        "test_efficientnet": get_efficientnet_model,
        "test_efficientnet_gn": get_efficientnet_model,
        "test_efficientnet_ln": get_efficientnet_model,
        "test_efficientnet_evos": get_efficientnet_model,
...
def get_family_model_f(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "fastvit_mci0": get_fastvit_model,
        "fastvit_mci1": get_fastvit_model,
        "fastvit_mci2": get_fastvit_model,
...
def get_family_model_h(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "sam2_hiera_tiny": get_hieradet_sam2_model,
        "sam2_hiera_small": get_hieradet_sam2_model,
        "sam2_hiera_base_plus": get_hieradet_sam2_model,
        "sam2_hiera_large": get_hieradet_sam2_model,
        "hieradet_small": get_hieradet_sam2_model,
...
def get_family_model_m(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "mobilenetv3_large_150d": get_mobilenet_model,
        ...
        "mobilenetv4_conv_small_035": get_mobilenet_model,
        "mobilenetv4_conv_small_050": get_mobilenet_model,
...
def get_family_model_v(model_type, num_classes):
    ...
    model_retrieval_functions = {
        ...
        "vit_intern300m_patch14_448": get_vision_transformer_model,
        "test_vit": get_vision_transformer_model,
        "test_vit2": get_vision_transformer_model,
        "test_vit3": get_vision_transformer_model,
        ...
        "vitamin_small_224": get_vitamin_model,
        "vitamin_base_224": get_vitamin_model,
        "vitamin_large_224": get_vitamin_model,
        "vitamin_large_256": get_vitamin_model,
        "vitamin_large_336": get_vitamin_model,
        "vitamin_large_384": get_vitamin_model,
        "vitamin_large2_224": get_vitamin_model,
        "vitamin_large2_256": get_vitamin_model,
        "vitamin_large2_336": get_vitamin_model,
        "vitamin_large2_384": get_vitamin_model,
