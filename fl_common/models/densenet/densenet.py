...
def get_densenet_model(densenet_type='DenseNet121', num_classes=1000):
...
model = get_densenet_model(densenet_type=densenet_type, num_classes=num_classes)
...
xai_methods = [
    ...
    DeepLift(model),
    # LayerCondductance(model.features[7], model),
