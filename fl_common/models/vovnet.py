...
def get_vovnet_model(vovnet_type, num_classes):
    ...
    if vovnet_type == 'vovnet39a':
        ...
        try:
            vovnet_model = create_model('ese_vovnet39b', pretrained=True, num_classes=num_classes)
        except:
        ...
        try:
            vovnet_model = create_model('ese_vovnet99b', pretrained=True, num_classes=num_classes)
        except:
        ...
        try:
            vovnet_model = create_model('ese_vovnet39b_evos', pretrained=True, num_classes=num_classes)
        except:
