...
# Model Parameters
mobilenet_type = 'MobileNet_V3_Small'
best_val_loss = float('inf')  # Initialize the best validation loss
save_dir = 'c:/TFE/Models/' + mobilenet_type + '/'  # Replace with the actual path where to save results
...
model = get_mobilenet_model(mobilenet_type=mobilenet_type, num_classes=num_classes)
