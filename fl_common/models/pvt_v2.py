...
def get_pvt_v2_model(pvt_v2_type, num_classes):
    ...
    if pvt_v2_type=='pvt_v2_b0':
        pvt_v2_model = create_model('pvt_v2_b0', pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b1':
        pvt_v2_model = create_model('pvt_v2_b1', pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b2':
        pvt_v2_model = create_model('pvt_v2_b2', pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b3':
        pvt_v2_model = create_model('pvt_v2_b3', pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b4':
        pvt_v2_model = create_model('pvt_v2_b4',pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b5':
        pvt_v2_model = create_model('pvt_v2_b5', pretrained=True, num_classes=num_classes)
    elif pvt_v2_type=='pvt_v2_b2_li':
        pvt_v2_model = create_model('pvt_v2_b2_li', pretrained=True, num_classes=num_classes)
    else:
