...
def get_xcit_model(xcit_type, num_classes):
    ...
    if xcit_type == 'xcit_nano_12_p16_224':
        ...
        xcit_model = create_model('xcit_medium_24_p8_24', pretrained=True, num_classes=num_classes)
        ...
        xcit_model = create_model('xcit_large_24_p8_24', pretrained=True, num_classes=num_classes)
