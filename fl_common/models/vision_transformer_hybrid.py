...
def get_vision_transformer_hybrid_model(vision_transformer_hybrid_type, num_classes):
    ...
    valid_types = {
        ...
        'vit_base_r26_s32_224', 'vit_base_r50_s16_224',
        'vit_base_r50_s16_384', 'vit_large_r50_s32_224',
        'vit_large_r50_s32_384', 'vit_small_resnet26d_224',
        'vit_small_resnet50d_s16_224', 'vit_base_resnet26d_224',
