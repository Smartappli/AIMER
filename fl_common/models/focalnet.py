...
def get_focalnet_model(focalnet_type, num_classes):
    ...
    if focalnet_type == 'focalnet_tiny_srf':
        focalnet_model = create_model('focalnet_tiny_srf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_small_srf':
        focalnet_model = create_model('focalnet_small_srf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_base_srf':
        focalnet_model = create_model('focalnet_base_srf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_tiny_lrf':
        focalnet_model = create_model('focalnet_tiny_lrf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_small_lrf':
        focalnet_model = create_model('focalnet_small_lrf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_base_lrf':
        focalnet_model = create_model('focalnet_base_lrf', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_large_fl3':
        focalnet_model = create_model('focalnet_large_fl3', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_large_fl4':
        focalnet_model = create_model('focalnet_large_fl4', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_xlarge_fl3':
        focalnet_model = create_model('focalnet_xlarge_fl3', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_xlarge_fl4':
        focalnet_model = create_model('focalnet_xlarge_fl4', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_huge_fl3':
        focalnet_model = create_model('focalnet_huge_fl3', pretrained=True, num_classes=num_classes)
    elif focalnet_type == 'focalnet_huge_fl4':
        focalnet_model = create_model('focalnet_huge_fl4', pretrained=True, num_classes=num_classes)
    else:
