...
save_dir = 'c:/TFE/Models/' + convnext_type + '/'  # Replace with the actual path where to save results
...
def get_convnext_model(convnext_type='ConvNeXt_Large', num_classes=1000):
