...
def get_resnetv2_model(resnetv2_type, num_classes):
    ...
    """
    valid_types = {
        'resnetv2_50x1_bit', 'resnetv2_50x3_bit', 'resnetv2_101x1_bit',
        'resnetv2_101x3_bit', 'resnetv2_152x2_bit', 'resnetv2_152x4_bit',
        'resnetv2_50', 'resnetv2_50d', 'resnetv2_50t', 'resnetv2_101',
        'resnetv2_101d', 'resnetv2_152', 'resnetv2_152d', 'resnetv2_50d_gn',
    ...
    try:
        ...
        return create_model(resnetv2_type, pretrained=False, num_classes=num_classes)
