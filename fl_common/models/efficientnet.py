...
def get_efficientnet_model(efficientnet_type, num_classes):
    ...
    - efficientnet_type (str): Type of EfficientNet architecture to be loaded.
      Options: 'EfficientNetB0', 'EfficientNetB1', 'EfficientNetB2', 'EfficientNetB3', 'EfficientNetB4',
               ...
               'efficientnet_b3_gn', 'efficientnet_b3_g8_gn', 'efficientnet_blur_b0', 'efficientnet_es',
               'efficientnet_es_pruned', 'efficientnet_em', 'efficientnet_el', 'efficientnet_el_pruned',
               'efficientnet_cc_b0_4e', 'efficientnet_cc_b0_8e', 'efficientnet_cc_b1_8e', 'efficientnet_lite0',
               'efficientnet_lite1', 'efficientnet_lite2', 'efficientnet_lite3', 'efficientnet_lite4',
               'efficientnet_b1_pruned', 'efficientnet_b2_pruned', 'efficientnet_b3_pruned', 'efficientnetv2_rw_t',
               'gc_efficientnetv2_rw_t', 'efficientnetv2_rw_s', 'efficientnetv2_rw_m', 'efficientnetv2_s',
               'efficientnetv2_m', 'efficientnetv2_l', 'efficientnetv2_xl', 'tf_efficientnet_b0', 'tf_efficientnet_b1',
               'tf_efficientnet_b2', 'tf_efficientnet_b3', 'tf_efficientnet_b4', 'tf_efficientnet_b5',
               'tf_efficientnet_b6', 'tf_efficientnet_b7', 'tf_efficientnet_b8', 'tf_efficientnet_l2',
               'tf_efficientnet_es', 'tf_efficientnet_em', 'tf_efficientnet_el', 'tf_efficientnet_cc_b0_4e',
               'tf_efficientnet_cc_b0_8e', 'tf_efficientnet_cc_b1_8e', 'tf_efficientnet_lite0', 'tf_efficientnet_lite1',
               'tf_efficientnet_lite2', 'tf_efficientnet_lite3', 'tf_efficientnet_lite4', 'tf_efficientnetv2_s',
               'tf_efficientnetv2_m', 'tf_efficientnetv2_l', 'tf_efficientnetv2_xl', 'tf_efficientnetv2_b0',
               'tf_efficientnetv2_b1', 'tf_efficientnetv2_b2', 'tf_efficientnetv2_b3', 'efficientnet_x_b3',
               'efficientnet_x_b5', 'efficientnet_h_b5', 'mixnet_s', 'mixnet_m', 'mixnet_l', 'mixnet_xl', 'mixnet_xxl',
               'tf_mixnet_s', 'tf_mixnet_m', 'tf_mixnet_l', 'tinynet_a', 'tinynet_b', 'tinynet_c', 'tinynet_d',
               'tinynet_e'
