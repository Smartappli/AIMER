...
def get_repvit_model(repvit_type, num_classes):
    ...
    if repvit_type == 'repvit_m1':
        repvit_model = create_model('repvit_m1', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m2':
        repvit_model = create_model('repvit_m2', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m3':
        repvit_model = create_model('repvit_m3', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m0_9':
        repvit_model = create_model('repvit_m0_9', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m1_0':
        repvit_model = create_model('repvit_m1_0', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m1_1':
        repvit_model = create_model('repvit_m1_1', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m1_5':
        repvit_model = create_model('repvit_m1_5', pretrained=True, num_classes=num_classes)
    elif repvit_type == 'repvit_m2_3':
        repvit_model = create_model('repvit_m2_3', pretrained=True, num_classes=num_classes)
    else:
