...
class ProcessingVisionTransformerTestCase(TestCase):
    ...
    def test_get_vision_model(self):
        ...
        vision_types = ["vit_base_patch16_siglip_224", "vit_base_patch16_siglip_256", "vit_base_patch16_siglip_384",
                        "vit_base_patch16_siglip_512", "vit_large_patch16_siglip_256",
